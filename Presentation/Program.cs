...
namespace Presentation
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddTransient<IStoreDataAccess<Store>, StoreDataAccess<Store>>();
            builder.Services.AddTransient<IProductService, ProductService>();
            builder.Services.AddTransient<IProductDataAccess<Product>, ProductDataAccess<Product>>();
